...
def main():
    ...
    load_model(model, device, saved_dir="models", file_name="deeplabv3plus_resnext50_32x4d_nonNorm.pt")
    model.to(device)
    ...
    # submission.csv로 저장
    submission.to_csv("./submission/deeplabv3plus_resnext50_32x4d_nonNorm.csv", index=False)
