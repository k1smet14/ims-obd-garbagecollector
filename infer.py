...
if __name__=='__main__':
    ...
    parser.add_argument('--weight_file',type=str,default='swin_b_256_seed2536_batch32_LR5e-05_Eta1e-07_epoch37_score10.440_score20.455_score30.619.pt')
